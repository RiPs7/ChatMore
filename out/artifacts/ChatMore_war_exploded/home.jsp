...
<div class="heading-row">
    <div class="heading-logo">
        <img src="images/chat_more_logo.png" class="logo-image"/>
        <a href="login.jsp">
            <div class="heading-text">
                <span style="font-size:40px">
                    <strong>
                        <span style="color:white">Chat</span><span style="color:black">More</span>
                    </strong>
                </span>
            </div>
        </a>
    ...
    <div class="main-content">
        <%
            ...
            try {
                ...
                PreparedStatement stmt = conn.prepareStatement("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA=\"ChatMore\"");
