...
public class Values {
    ...
    public static String LDAP_PROVIDER_URL = "ldap://192.168.117.131:389/o=ChatMore,c=EL";
    public static String LDAP_SECURITY_AUTHENTICATION = "simple";
    public static String LDAP_SECURITY_PRINCIPAL = "cn=ChatMore,c=EL";
    public static String LDAP_SECURITY_CREDENTIALS = "chatmore";
